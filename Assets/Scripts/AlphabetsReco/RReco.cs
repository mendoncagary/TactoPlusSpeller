...
public class RReco : MonoBehaviour,ITrackableEventHandler
{
		...
		TrackableBehaviour.Status newStatus)
	{
			...
			newStatus == TrackableBehaviour.Status.EXTENDED_TRACKED)
		{
			...
			//StartCoroutine (TextToSpeech.DownloadTheAudio ("Detected R", audio));
			//StartCoroutine (TextToSpeech.DownloadTheAudio (TextToSpeech.level.ToString(), audio));
