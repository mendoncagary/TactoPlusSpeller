...
public class CowPanelScript : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		StartCoroutine (TextToSpeech.DownloadTheAudio("It’s a farm animal that has two horns. It gives milk and likes to graze on grasslands. Guess what it could be..",audio));
