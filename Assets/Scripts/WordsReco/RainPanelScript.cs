...
public class RainPanelScript : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		StartCoroutine (TextToSpeech.DownloadTheAudio("It's a 4 letter word",audio));
		yield return new WaitForSeconds(5f);

		StartCoroutine (TextToSpeech.DownloadTheAudio("It comes down from clouds in small drops, and makes puddles on the street. If you get wet in it, you might catch a cold.",audio));
